import { Query, Params, Paginated, Id, PaginationParams, PaginationOptions } from '@nxpkg/nxpkg'
...
// re-export from @nxpkg/nxpkg to prevent breaking changes
 ...
 * side and only for the Nxpkg database adapters.
 *
 * These methods do not trigger events.
 *
 * @see {@link https://docs.nxpkg.khulnasoft.com/guides/migrating.html#hook-less-service-methods}
 */
...
> {
   ...
   * @see {@link https://docs.nxpkg.khulnasoft.com/api/services.html#get-id-params|Nxpkg API Documentation: .get(id, params)}
   */
   ...
   * @param params - Service call parameters {@link Params}
   * @see {@link HookLessServiceMethods}
   * @see {@link https://docs.nxpkg.khulnasoft.com/api/services.html#create-data-params|Nxpkg API Documentation: .create(data, params)}
   */
   ...
   * @param params - Service call parameters {@link Params}
   * @see {@link HookLessServiceMethods}
   * @see {@link https://docs.nxpkg.khulnasoft.com/api/services.html#update-id-data-params|Nxpkg API Documentation: .update(id, data, params)}
   */
   ...
   * @param params - Service call parameters {@link Params}
   * @see {@link HookLessServiceMethods}
   * @see {@link https://docs.nxpkg.khulnasoft.com/api/services.html#patch-id-data-params|Nxpkg API Documentation: .patch(id, data, params)}
   */
   ...
   * @param params - Service call parameters {@link Params}
   * @see {@link HookLessServiceMethods}
   * @see {@link https://docs.nxpkg.khulnasoft.com/api/services.html#remove-id-params|Nxpkg API Documentation: .remove(id, params)}
   */
