...
describe('@nxpkg/authentication-client', () => {
  ...
  it('authenticate, authentication hook, login event', async () => {
    ...
    at = await Promise.resolve(app.get('storage').getItem('nxpkg-jwt'))
  ...
  describe('reauthenticate', () => {
    ...
    it('reauthenticates when token is in storage', async () => {
      ...
      let at = await Promise.resolve(app.get('storage').getItem('nxpkg-jwt'))
