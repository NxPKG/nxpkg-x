...
import { getServiceOptions, defaultServiceMethods, createContext } from '@nxpkg/nxpkg'
...
const debug = createDebug('@nxpkg/koa/rest')
...
const serviceMiddleware = (): Middleware => {
  return async (ctx, next) => {
    ...
    const params = { query, headers, route, ...ctx.nxpkg }
