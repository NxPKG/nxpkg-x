...
import { NotAuthenticated } from '@nxpkg/errors'
...
const debug = createDebug('@nxpkg/authentication/base')
...
export interface AuthenticationStrategy {
  ...
  /**
   * Implement this method to get access to the Nxpkg application
   *
   * @param app The Nxpkg application instance
   */
