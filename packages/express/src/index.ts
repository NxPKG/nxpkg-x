...
import { Application as NxpkgApplication, defaultServiceMethods } from '@nxpkg/nxpkg'
...
const debug = createDebug('@nxpkg/express')

export default function nxpkgExpress<S = any, C = any>(
  ...
  if (typeof nxpkgApp.setup !== 'function') {
    throw new Error('@nxpkg/express requires a valid Nxpkg application instance')
  }
  ...
  Object.assign(app, {
    use(location: string & keyof S, ...rest: any[]) {
      ...
      // Since this is a service, call Nxpkg `.use`
      nxpkgUse.call(this, location, service, {
        express: middleware,
        ...options
      })
  ...
  const newDescriptors = {
    ...Object.getOwnPropertyDescriptors(Object.getPrototypeOf(nxpkgApp)),
    ...Object.getOwnPropertyDescriptors(nxpkgApp)
  }
  ...
  app.use((req, _res, next) => {
    req.nxpkg = { ...req.nxpkg, provider: 'rest' }
    return next()
  })
...
if (typeof module !== 'undefined') {
  module.exports = Object.assign(nxpkgExpress, module.exports)
}
