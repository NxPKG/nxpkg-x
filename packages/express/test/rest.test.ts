...
import { ApplicationHookMap, nxpkg, HookContext, Id, Params } from '@nxpkg/nxpkg'
import { Service, restTests } from '@nxpkg/tests'
...
describe('@nxpkg/express/rest provider', () => {
  describe('base functionality', () => {
    it('throws an error if you did not expressify', () => {
      ...
      try {
        ...
        assert.strictEqual(e.message, '@nxpkg/express/rest needs an Express compatible app.')
      }
    })
  ...
  describe('middleware', () => {
    ...
    it('formatter does nothing when there is no res.data', async () => {
      ...
      const app = expressify(nxpkg()).use('/test', express.formatter, (_req: Request, res: Response) =>
        res.json(data)
      )
