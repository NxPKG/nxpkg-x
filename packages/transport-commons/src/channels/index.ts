import { Application, NxpkgService, RealTimeConnection, getServiceOptions } from '@nxpkg/nxpkg'
...
const debug = createDebug('@nxpkg/transport-commons/channels')
const { CHANNELS } = keys
...
export function channels() {
  return (app: Application) => {
    ...
    app.mixins.push((service: NxpkgService, path: string) => {
