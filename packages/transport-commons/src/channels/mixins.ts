...
import { Application, HookContext, getServiceOptions, defaultServiceEvents } from '@nxpkg/nxpkg'
import { createDebug } from '@nxpkg.khulnasoft.commons'
import { Channel } from './channel/base'
import { CombinedChannel } from './channel/combined'

const debug = createDebug('@nxpkg/transport-commons/channels/mixins')
const PUBLISHERS = Symbol.for('@nxpkg/transport-commons/publishers')
const CHANNELS = Symbol.for('@nxpkg/transport-commons/channels')
const ALL_EVENTS = Symbol.for('@nxpkg/transport-commons/all-events')
