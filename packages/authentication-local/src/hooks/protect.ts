...
/**
 * @deprecated For reliable safe data representations use Nxpkg schema dispatch resolvers.
 * @see https://dove.nxpkg.khulnasoft.comapi/authentication/local.html#protecting-fields
 */
