...
import { Query, Params } from '@nxpkg/nxpkg'
import { AuthenticationRequest, AuthenticationBaseStrategy } from '@nxpkg/authentication'
import { createDebug } from '@nxpkg.khulnasoft.commons'

const debug = createDebug('@nxpkg/authentication-local/strategy')
