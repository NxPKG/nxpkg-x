...
import { nxpkg, Paginated } from '@nxpkg/nxpkg'
import { KnexAdapterParams, KnexService, transaction } from '../src'
import { PaginationOptions } from '@nxpkg/adapter-commons'
...
describe('Nxpkg Knex Overridden Method With Self-Join', () => {
  let ancestor: Animal
  let animal: Animal

  const app = nxpkg<{ animals: AnimalService }>()
    .hooks({
