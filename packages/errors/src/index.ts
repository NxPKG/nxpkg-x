export interface NxpkgErrorJSON {
  name: string
  message: string
  code: number
  className: string
...
interface ErrorProperties extends Omit<NxpkgErrorJSON, 'message'> {
  type: string
}
...
export class BadRequest extends NxpkgError {
...
export class NotAuthenticated extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 402 - Payment Error
export class PaymentError extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 403 - Forbidden
export class Forbidden extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 404 - Not Found
export class NotFound extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
export class MethodNotAllowed extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 406 - Not Acceptable
export class NotAcceptable extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 408 - Timeout
export class Timeout extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 409 - Conflict
export class Conflict extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 410 - Gone
export class Gone extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 411 - Length Required
export class LengthRequired extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 422 Unprocessable
export class Unprocessable extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
export class TooManyRequests extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 500 - General Error
export class GeneralError extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 501 - Not Implemented
export class NotImplemented extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 502 - Bad Gateway
export class BadGateway extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 503 - Unavailable
export class Unavailable extends NxpkgError {
  constructor(message?: ErrorMessage, data?: any) {
...
export function convert(error: any) {
  ...
  const NxpkgError = (errors as any)[error.name]
  const result = NxpkgError
    ? new NxpkgError(error.message, error.data)
