...
describe('@nxpkg/errors', () => {
  describe('errors.convert', () => {
    it('converts objects to nxpkg errors', () => {
      const error = convert({
        name: 'BadRequest',
        message: 'Hi',
        expando: 'Me'
  ...
  describe('inheritance', () => {
    ...
    it('follows the prototypical inheritance chain', () => {
      const error = new errors.MethodNotAllowed()
      assert.ok(error instanceof Error)
      assert.ok(error instanceof errors.NxpkgError)
    })
  ...
  describe('successful error creation', () => {
    describe('without custom message', () => {
      it('default error', () => {
        ...
        assert.strictEqual(error instanceof errors.NxpkgError, true)
      })
