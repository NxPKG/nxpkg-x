import { generator, toFile, after, prepend } from '@nxpkghq/pinion'
...
export const template = ({
  ...
  schema,
  fileName
}: ServiceGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/service.html
${authentication || isEntityService ? `import { authenticate } from '@nxpkg/authentication'` : ''}
${
  schema
    ? `
