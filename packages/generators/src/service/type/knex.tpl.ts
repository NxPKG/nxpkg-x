...
const migrationTemplate = ({
  ...
  authStrategies,
  isEntityService
}: ServiceGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/knexfile.html
...
export const template = ({
  ...
  fileName,
  relative
}: ServiceGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/service.class.html#database-services
...
export const getOptions = (app: Application): KnexAdapterOptions => {
  return {
    ...
    Model: app.get('${nxpkg.database}Client'),
    name: '${fileName}'
  }
}
`
