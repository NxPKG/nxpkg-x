import { generator, toFile, before, prepend, append } from '@nxpkghq/pinion'
import { ConnectionGeneratorContext } from '../index'
import { injectSource, renderSource } from '../../commons'

const template = ({
  database
}: ConnectionGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/databases.html
...
const keywordImport = `import { keywordObjectId } from '@nxpkg/mongodb'`
