import { generator, runGenerator, prompt, install, mergeJSON, toFile, when } from '@nxpkghq/pinion'
...
export interface ConnectionGeneratorContext extends NxpkgBaseContext {
  name?: string
...
export type ConnectionGeneratorArguments = NxpkgBaseContext &
    ...
    .then(
      when<ConnectionGeneratorContext>(
        ...
        async (ctx: ConnectionGeneratorContext) => {
          ...
          dependencies.push(`@nxpkg/${adapter}`)
