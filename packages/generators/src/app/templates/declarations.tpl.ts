import { generator, toFile, when, renderTemplate } from '@nxpkghq/pinion'
import { AppGeneratorContext } from '../index'

const template = ({
  framework,
  schema
}: AppGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/typescript.html
import { HookContext as NxpkgHookContext, NextFunction } from '@nxpkg/nxpkg'
import { Application as NxpkgApplication } from '@nxpkg/${framework}'
${
  schema === false
