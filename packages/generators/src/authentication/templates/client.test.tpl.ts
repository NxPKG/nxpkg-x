...
const template = ({
  ...
  type,
  lib
}: AuthenticationGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/client.test.html
import assert from 'assert'
import axios from 'axios'

import rest from '@nxpkg/rest-client'
${localTemplate(authStrategies, `import authenticationClient from '@nxpkg/authentication-client'`)}
