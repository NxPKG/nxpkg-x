import { generator, before, toFile } from '@nxpkghq/pinion'
...
const template = ({
  authStrategies
}: AuthenticationGeneratorContext) => /* ts */ `// For more information about this file see https://dove.nxpkg.khulnasoft.com/guides/cli/authentication.html
import { AuthenticationService, JWTStrategy } from '@nxpkg/authentication'
${localTemplate(authStrategies, `import { LocalStrategy } from '@nxpkg/authentication-local'`)}
${oauthTemplate(authStrategies, `import { oauth, OAuthStrategy } from '@nxpkg/authentication-oauth'`)}
