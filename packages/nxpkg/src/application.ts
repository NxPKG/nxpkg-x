...
import { stripSlashes, createDebug } from '@nxpkg.khulnasoft.commons'
import { HOOKS, hooks, middleware } from '@nxpkg/hooks'
...
const debug = createDebug('@nxpkg/nxpkg')

export class Nxpkg<Services, Settings>
  extends EventEmitter
  implements NxpkgApplication<Services, Settings>
{
