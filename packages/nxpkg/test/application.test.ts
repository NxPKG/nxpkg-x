...
import { nxpkg, Nxpkg, getServiceOptions, Id, version } from '../src'

describe('Nxpkg application', () => {
  it('initializes', () => {
    const app = nxpkg()

    assert.ok(app instanceof Nxpkg)
  })
  ...
  describe('Services', () => {
    ...
    it('registers and wraps a new service and can unregister (#2035)', async () => {
      ...
      const app = nxpkg<{ dummy: typeof dummyService }>().use('dummy', dummyService)
    ...
    it('services can be re-used (#566)', (done) => {
      ...
      const app1 = nxpkg<{ dummy: typeof service; testing: any }>()
      const app2 = nxpkg<{ dummy: typeof service; testing: any }>()
    ...
    it('async hooks run before regular hooks', async () => {
      ...
      const app = nxpkg<{ dummy: typeof service }>()
    ...
    it('services conserve Symbols', () => {
      ...
      const app = nxpkg().use('/dummy', dummyService)
      const wrappedService = app.service('dummy')
