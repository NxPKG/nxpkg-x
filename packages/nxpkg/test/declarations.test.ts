...
import { nxpkg, ServiceInterface, Application, HookContext, NextFunction } from '../src'
...
describe('Nxpkg typings', () => {
  it('initializes the app with proper types', async () => {
    const app: MainApp = nxpkg<Services, Configuration>()
    const app2 = nxpkg<Record<string, unknown>, Configuration>()
