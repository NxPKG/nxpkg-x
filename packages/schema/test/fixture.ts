import { nxpkg, HookContext, Application as NxpkgApplication } from '@nxpkg/nxpkg'
import { memory, MemoryService } from '@nxpkg/memory'
import { GeneralError } from '@nxpkg/errors'
import { AdapterParams } from '@nxpkg/adapter-commons'
...
type Application = NxpkgApplication<ServiceTypes>
