...
import { compose } from '@nxpkg/hooks'
...
export const DISPATCH = Symbol.for('@nxpkg/schema/dispatch')
 ...
 * @see https://dove.nxpkg.khulnasoft.com/guides/cli/service.schemas.html
 */
