import { _ } from '@nxpkg.khulnasoft.commons'
...
/**
 * Create a Nxpkg query syntax compatible JSON schema definition for a property definition.
 *
 ...
 * @returns A JSON schema definition for the Nxpkg query syntax for this property.
 */
...
/**
 * Creates Nxpkg a query syntax compatible JSON schema for multiple properties.
 *
 * @param definitions A map of property definitions
 * @param extensions Additional properties to add to the query property schema
 * @returns The JSON schema definition for the Nxpkg query syntax for multiple properties
 */
...
/**
 * Creates a JSON schema for the complete Nxpkg query syntax including `$limit`, $skip`
