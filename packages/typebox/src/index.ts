...
import { jsonSchema, Validator, DataValidatorMap, Ajv } from '@nxpkg/schema'
...
/**
 * Creates the `$sort` Nxpkg query syntax schema for an object schema
 *
...
/**
 * Returns the standard Nxpkg query syntax for a property schema,
 ...
 * @returns The Nxpkg query syntax schema
 */
...
/**
 * Creates a Nxpkg query syntax schema for the properties defined in `definition`.
 *
 * @param definition The properties to create the Nxpkg query syntax schema for
...
/**
 * Creates a TypeBox schema for the complete Nxpkg query syntax including `$limit`, $skip`, `$or`
 ...
 * @returns A TypeBox object representing the complete Nxpkg query syntax for the given properties
 */
