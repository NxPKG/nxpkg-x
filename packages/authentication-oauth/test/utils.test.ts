import { AuthenticationService } from '@nxpkg/authentication/lib'
import { nxpkg } from '@nxpkg/nxpkg/lib'
import { strict as assert } from 'assert'
import { getGrantConfig } from '../src/utils'

describe('@nxpkg/authentication-oauth/utils', () => {
  it('getGrantConfig initialises Grant defaults', () => {
    const app = nxpkg<{ authentication: AuthenticationService }>()
